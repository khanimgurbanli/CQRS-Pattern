        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Category_Category_SupCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryRegion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Contact = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AddressDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "BookPriceDiscount",
                columns: table => new
                {
                    BookPricesId = table.Column<int>(type: "int", nullable: false),
                    DiscountsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPriceDiscount", x => new { x.BookPricesId, x.DiscountsId });
                    table.ForeignKey(
                        name: "FK_BookPriceDiscount_BookPrices_BookPricesId",
                        column: x => x.BookPricesId,
                        principalTable: "BookPrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPriceDiscount_Discount_DiscountsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_BookPrices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "BookPrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_Publishers_PubliserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPriceDiscount_DiscountsId",
                table: "BookPriceDiscount",
                column: "DiscountsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_SupCategoryId",
                table: "Category",
